...
namespace FuseWPVendor\WP_Queue;

use Exception;
use FuseWPVendor\WP_Queue\Connections\ConnectionInterface;
use FuseWPVendor\WP_Queue\Connections\DatabaseConnection;
use FuseWPVendor\WP_Queue\Connections\RedisConnection;
use FuseWPVendor\WP_Queue\Connections\SyncConnection;
use FuseWPVendor\WP_Queue\Exceptions\ConnectionNotFoundException;
class QueueManager
{
    /**
     * @var array
